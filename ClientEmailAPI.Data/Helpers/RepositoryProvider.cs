...
namespace ClientEmailAPI.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<ClientDbContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<ClientDbContext, object> factory, ClientDbContext dbContext)
        {
