...
namespace ClientEmailAPI.Data.Helpers
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<ClientDbContext, object>> GetFactories()
        {
            return new Dictionary<Type, Func<ClientDbContext, object>>
            { 
                    {typeof(IWebRepository), dbContext => new WebRepository(dbContext) },
                    {typeof(IMobileRepository), dbContext => new MobileRepository(dbContext) },
            };
        }
        ...
        /// </remarks>
        public RepositoryFactories(IDictionary<Type, Func<ClientDbContext, object>> factories )
        {
        ...
        /// </remarks>
        public Func<ClientDbContext, object> GetRepositoryFactory<T>()
        {
       
            Func<ClientDbContext, object> factory;
        ...
        /// </remarks>
        public Func<ClientDbContext, object> GetRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        protected virtual Func<ClientDbContext, object> DefaultEntityRepositoryFactory<T>() where T : class
        {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<ClientDbContext, object>> _repositoryFactories;
